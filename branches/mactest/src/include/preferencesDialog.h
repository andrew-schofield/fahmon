...
protected:
	...
	wxTextCtrl   *mWebAppWebAppLocation;
	wxStaticText *mWebAppWebAppLabel;
	wxButton     *mWebAppWebAppLocationChooser;
	wxCheckBox   *mWebAppUseWebApp;
	wxTextCtrl   *mWebAppSimpleWebLocation;
	wxStaticText *mWebAppSimpleWebLabel;
	wxButton     *mWebAppSimpleWebLocationChooser;
	wxCheckBox   *mWebAppUseSimpleWeb;
	wxTextCtrl   *mWebAppSimpleTextLocation;
	wxStaticText *mWebAppSimpleTextLabel;
	wxButton     *mWebAppSimpleTextLocationChooser;
	wxCheckBox   *mWebAppUseSimpleText;
